        ...
        <nav className="bg-white">
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 m-4">
                <div className="relative flex items-center justify-between h-16">
                    ...
                    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start space-x-9">
                        ...
                        <div className="hidden sm:block sm:ml-6">
                            <div className="flex space-x-4">
                                <Link
                                    href="/"
                                    className="text-black hover:text-indigo-500 relative px-3 py-2 rounded-md text-sm font-medium transition duration-300 ease-in-out"
                                >
                                    Home
                    ...
                    <div className="flex space-x-7 relative">
                        ...
                        {isProfileOpen && (
                            <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                                <Link
                                    href="/pages/login"
                                    className="block px-4 py-2 text-sm text-black hover:bg-indigo-500 hover:text-white transition duration-300"
                                >
                                    Login
                                </Link>
                                <Link
            ...
            <div className={`sm:hidden ${isOpen ? "block" : "hidden"}`} id="mobile-menu">
                <div className="px-2 pt-2 pb-3 space-y-1">
                    <Link
                        href="/"
                        className="text-black hover:text-indigo-500 block px-3 py-2 rounded-md text-base font-medium transition duration-300 ease-in-out"
                    >
                        Home
                    </Link>
                    <Link
